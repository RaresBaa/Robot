...
public class Configuration {
    ...
    public static double S_Tray_Front_Up = 0.6;
    public static double S_Tray_Front_Down = 0.4;
    public static double S_Tray_Back_UP = 0.4;
    public static double S_Tray_Back_Down = 0.6;

    public static double S_Claw_Opened = 0.6;
