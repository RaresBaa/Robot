...
class Configuration {
    ...
    static final double S_Tray_Front_Up = 0.6;
    static final double S_Tray_Front_Down = 0.4;
    static final double S_Tray_Back_UP = 0.4;
    static final double S_Tray_Back_Down = 0.6;
    ...
    static final int Park_Steps = 1000;  //distance to the parking line
    ...
    static final long Block_Drop_Time = 500; //mileconds for the intake to release the block
