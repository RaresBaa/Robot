...
public class Configuration {
    ...
    public static double S_Intake_Left_Up = 1.0;
    public static double S_Intake_Left_Down = 0.179;
    public static double S_Intake_Right_Up = 0.069;
    public static double S_Intake_Right_Down = 0.91;

    public static double S_Tray_Front_Up = 0.85;
    public static double S_Tray_Front_Down = 0.08;
