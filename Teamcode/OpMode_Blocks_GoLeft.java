...
//Left-Tray Right-Blocks

@Autonomous(name="Blocks_GoLeft_RED", group="Auto")
public class OpMode_Blocks_GoLeft extends LinearOpMode{
    ...
    public void runOpMode(){
        ...
        GoToPosition();
        LogTelemetery();
        //go to the other side- tray side
        GoTargetLeft(Block_Steps_Distance);
        GoToPosition();
        LogTelemetery();
        //drop the block off
        hardware.Intake_Power(-1);
        sleep(Servo_Wait);
        hardware.Intake_Power(0);
        //go to the other side + one block distance - blocks side
        ...
        GoToPosition();
        LogTelemetery();
        //go to the other side + one block distance -tray side
        ...
        sleep(Servo_Wait);
        hardware.Intake_Power(0);
        //go to the other side + two block distance -blocks side
        ...
        GoToPosition();
        LogTelemetery();
        //go to the other side + two block distance -tray side
        ...
        hardware.Intake_Power(0);
        //Park
        GoTargetBack(Block_Park_Distance);
        GoToPosition();
